          ...
          <ul className="space-y-2">
            ...
            <li>
              ...
              >
                <FontAwesomeIcon
                  icon={faHouse}
                  className="flex-shrink-0 pr-2 w-8 h-8 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white"
                />
            ...
            <li>
              <div className="btn text-white w-full font-bold text-xl flex rounded-3xl px-4 py-2 justify-center items-center border border-indigo-500 font-semibold cursor-pointer bg-[#1DA1F2]">
                Tweet
              </div>
            </li>
          </ul>
