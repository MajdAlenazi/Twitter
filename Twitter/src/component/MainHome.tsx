      ...
      <div className="bg-red-400 editor w-full flex flex-col text-gray-800 border border-gray-300 p-2 shadow-lg">
        <div className="flex items-center flex-row w-full">
          ...
          <input
            ...
            className="title bg-gray-100 w-full border border-gray-300 p-2 mb-2 outline-none"
        ...
        <div className="flex flex row ml-10">
          ...
          {/* <!-- buttons --> */}
          <div className="count ml-auto text-gray-400 text-sm mt-4 font-semibold">
            0/300
          </div>
          <div
            onClick={Tweet}
            className="btn w-fit flex rounded-3xl justify-end items-center border border-indigo-500 p-1 px-6 font-semibold cursor-pointer text-gray-200 ml-2 bg-indigo-500"
          >
            Tweet
          </div>
        </div>
            ...
            <div className="flex bg-[#15202C] shadow-lg rounded-lg mx-4 md:mx-auto my-56 max-w-md md:max-w-2xl ">
              <div className="flex items-start px-4 py-6">
                ...
                <div className="">
                  ...
                  <p className="mt-3 text-gray-700 text-sm">{item.postTweet}</p>
