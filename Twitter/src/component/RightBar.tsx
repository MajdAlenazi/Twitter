    ...
    <div className="bg-[#15202C] w-1/3 border-l border-gray-400 px-10 mt-1 ">
        ...
        <form>
          <div className="relative">
            ...
            <input
              type="search"
              id="default-search"
              className="block p-3 pl-10 w-full text-lg text-gray-900 bg-gray-50 rounded-3xl focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="Search"
              required
            />
          </div>
      ...
      <div className="justify-center py-6 w-full px-0">
        <div className="bg-[#1E2732] rounded-3xl shadow-lg p-4">
          <h1 className="text-2xl font-bold mb-4 justify-start text-white">
            What's happening
          </h1>
          <ul className="space-y-4">
            ...
            <li className="flex flex-col justify-start">
              <p className="text-blue-500 hover:underline">Show more</p>
            </li>
          </ul>
        </div>
      </div>
          ...
          <ul className="space-y-8">
            <li className="flex flex-row justify-between">
              <FontAwesomeIcon
                ...
                icon={faUser}
              ></FontAwesomeIcon>
              <p className="flex text-white  hover:underline">@username</p>
              <div className="flex">
                <button
                  type="button"
